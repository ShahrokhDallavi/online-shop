...
const loginBnner = () => {
    return (
        <div className='flex justify-center items-center'>
            ...
            <div className='absolute flex flex-col text-white bottom-40 px-5'>
                ...
                <Link to='/login'>
                    <button className='rounded-full py-2 w-full bg-white/15 backdrop-blur hover:border border-borderColor'>Log In</button>
                </Link>
                <Link to='/signup'>
                    <button className='rounded-full py-2 w-full my-2 bg-white/15 backdrop-blur hover:border border-borderColor'>Sign Up</button>
                </Link>
            </div>
        </div>
    );
