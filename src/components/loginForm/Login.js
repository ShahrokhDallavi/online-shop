...
const Login = () => {
    ...
    return (
        <div>
            ...
            <div className='bg-white/15 backdrop-blur mx-5 mt-8 mb-24 p-8 rounded-2xl text-black md:mx-36'>
                <form onSubmit={submitHandler}>
                    ...
                    <div className='flex justify-between items-center'>
                        <Link to="/signup" className='text-blue font-bold'>Sign Up</Link>
                        <button type='submit' className='bg-primaryColor text-white font-bold px-4 py-2 rounded-2xl'>Log in</button>
                    </div>
                </form>
            </div>
            <ToastContainer />
